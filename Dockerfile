...
RUN alternatives --install /usr/bin/jar jar /opt/jdk1.8.0_121/bin/jar 2 &&  alternatives --install /usr/bin/javac javac /opt/jdk1.8.0_121/bin/javac 2
RUN alternatives --set jar /opt/jdk1.8.0_121/bin/jar &&  alternatives --set javac /opt/jdk1.8.0_121/bin/javac
CMD /bin/bash
